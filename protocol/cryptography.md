...
│ ├──────────────────────┼───────────────┼───────────────┼────────────────┤ │
│ │ ECDSA (secp256k1) │ 64 bytes │ 33 bytes │ 128-bit (PQNo) │ │
│ │ Ed25519 │ 64 bytes │ 32 bytes │ 128-bit (PQNo) │ │
│ │ RSA-2048 │ 256 bytes │ 256 bytes │ 112-bit (PQNo) │ │
│ │ ML-DSA-44 (Dil2) │ 2,420 bytes │ 1,312 bytes │ NIST L2 (PQYes) │ │
│ │ ML-DSA-65 (Dil3) │ 3,293 bytes │ 1,952 bytes │ NIST L3 (PQYes) │ │
│ │ ML-DSA-87 (Dil5) │ 4,595 bytes │ 2,592 bytes │ NIST L5 (PQYes) │ │
│ │ SPHINCS+-128f │ 17,088 bytes │ 32 bytes │ NIST L1 (PQYes) │ │
│ │ SPHINCS+-256f │ 49,856 bytes │ 64 bytes │ NIST L5 (PQYes) │ │
│ ├──────────────────────┼───────────────┼───────────────┼────────────────┤ │
│ │ HYBRID (Aethelred) │ 3,357 bytes │ 1,985 bytes │ 128+L3 (PQYes) │ │
│ │ ECDSA + ML-DSA-65 │ │ │ │ │
│ └──────────────────────┴───────────────┴───────────────┴────────────────┘ │
│ │
