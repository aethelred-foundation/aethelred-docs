...
# ✓ TLS 1.3 supported
# ✓ Post-quantum signatures available
...
# ✓ TLS certificate valid (expires in 364 days)
...
def submit_compute_job(user_id: str, job_request: dict):
    ...
    audit.log(
        ...
        # input_data=job_request["encrypted_input"],  # ❌ Never log
    )
...
│  ✓ Report security issues to security@aethelred.io                         │
│                                                                              │
│  DON'T:                                                                     │
│  ✗ Hardcode secrets in code                                                │
│  ✗ Log sensitive data (PII, credentials)                                   │
│  ✗ Disable security features for "convenience"                             │
│  ✗ Skip code review for "urgent" changes                                   │
